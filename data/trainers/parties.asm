...
; Route 24
	db $FF, 14, PINSIR, 15, BEEDRILL, 0
; Route 6
	db 16, PARAS, METAPOD, KAKUNA, 0
	db 20, BUTTERFREE, 0
; Unused
...
; Mt. Moon 1F
	...
	db 14, CLEFAIRY, 0
; Route 24
	db 16, CLEFAIRY, NIDORINA, ODDISH, 0
...
; Route 24
	db $FF, 16, VULPIX, 16, PSYDUCK, 17, CUBONE, 0
; Route 6
	db 20, SQUIRTLE, 0
...
; Viridian Gym
	db $FF, 45, MAROWAK, 48, KANGASKHAN, 47, NIDOQUEEN, 47, NIDOKING, 50, RHYDON, 0
...
; Route 24
	db $FF, 15, ZUBAT, 16, KOFFING, 16, RATICATE, 17, RHYHORN, 0
; Game Corner
...
MistyData:
	db $FF, 18, STARYU, 18, PSYDUCK, 21, STARMIE, 0

LtSurgeData:
	db $FF, 23, VOLTORB, 23, MAGNEMITE, 25, RAICHU, 0

ErikaData:
	db $FF, 29, VICTREEBEL, 27, TANGELA, 28, EXEGGUTOR, 30, VILEPLUME, 0

KogaData:
	db $FF, 37, KOFFING, 39, MUK, 37, ARBOK, 40, VENOMOTH, 43, WEEZING, 0

BlaineData:
	db $FF, 44, NINETALES, 44, MAGMAR, 45, RAPIDASH, 45, ARCANINE, 47, CHARIZARD, 0

SabrinaData:
	db $FF, 40, KADABRA, 42, MR_MIME, 40, HYPNO, 41, JYNX, 44, ALAKAZAM, 0
